...
export default function RegisterForm() {
  ...
  return (
    <div className="flex flex-col items-center border-[2px] bg-[#D8DBE2] w-[600px] mx-auto rounded-xl text-black py-4 my-auto mt-5">
      <h2 className="text-center font-bold text-xl my-5">Bienvenue sur ENI EXCHANGE !</h2>
      ...
      <div className="flex flex-col items-center">
        <div className="flex flex-row justify-between w-full">
          <input
            type="text"
            value={nom}
            className="border-[1.5px] border-white my-2 p-2 mx-2 h-10"
            placeholder="Nom"
        ...
        <input
          type="text"
          value={birthday}
          className="w-full border-[1.5px] border-white my-2 p-2 mx-2 h-10"
      ...
      <div className="flex flex-row justify-evenly w-full">
        <div>
          <div onClick={() => setNiveauClicked(!niveauClicked)}>
            <span className="font-bold mr-2">Niveau</span>
        ...
        <div>
          <div onClick={() => setParcoursClicked(!parcoursClicked)}>
            <span className="font-bold mr-2">Parcours</span>
